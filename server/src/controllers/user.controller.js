import { postUser, putUser, deleteUser, getUser, addContact,userLogin, getFriends, searchFriends } from "../models/user/user.models.js";
...
export {insertUserToDatabase, updateUserInDatabase, deleteUserInDatabase, getUserFromDatabase, addContactInDatabase, logUserInDatabase, getUserFriendsFromDatabase, getSearchedUsersFromDatabase}