      ...
      return (
          <div className="w-screen h-screen flex items-center justify-center">
                <div className="w-4/5 lg:w-2/4 flex items-center justify-center" >
                  ...
                  <div className="flex flex-col justify-center gap-1 aspect-square items-center" >
                    <img src={user.image} alt="Foto de perfil" className="w-full h-full rounded-full object-cover object-center w-64 h-64"  />
